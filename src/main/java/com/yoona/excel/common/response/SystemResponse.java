...
public class SystemResponse<T> extends BaseResponse {
    ...
    public SystemResponse(Integer code, String errMsg) {
        this.setCode(code);
        this.setMsg(errMsg);
    }
    ...
    public static <T> SystemResponse<T> fail(Integer code, String errMsg) {
        return new SystemResponse<T>(code, errMsg);
    }
